...
// for (let friend = 0; friend <= sandeep.friends.length - 1; friend++) {
//     console.log(`Sandeep is hanging out with ${sandeep.friends[friend]}`);
// };

// // while loop
// let rep = 1;
// while (rep <= 10) {
//     console.log(`${rep}. sandeep is awesome!!`);
//     rep++;
// };
...
for (let i = 0; i < bills.length; i++) {
    ...
    console.log(`${i + 1}. The bill was $${bills[i]}, the tip was $${tips[i]} and the total bill paid was $${totals[i]}`);
};
// sum = 0
function calcAverage(arr) {
    ...
    const billAverage = sum / arr.length;
    return billAverage;
};
